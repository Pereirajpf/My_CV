...
\large{
\quad Recent graduate in a Master's degree in Bioinformatics with experience in \textbf{data analysis} and \textbf{programming}.\\ 
\null \quad Adaptative, committed, a team player and always eager to learn new things, challenges are always something he is looking for.\\
\null \quad Technically with a varied and constantly expanding portfolio, currently more committed to learning new techniques in software development and software applications in data analysis, but always ready to face challenges in new areas related to technology.
}
\end{minipage}}
\vspace{6mm}
